            ...
            <div class="container">
                <div class="inner">
                    ...
                    <?php
                        ...
                        $cUsername = "";
                        $cPass = "";
                        $username = "admin"; // temp username for testing
                    ...
                    <div>
                        ...
                        <p>If you are a Member, click on button below to switch to Member login screen</p>
                        <a href="memberLogin.php" class = "button">Switch</a>
                    </div>
